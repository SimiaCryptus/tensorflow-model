...
public final class ModelFlagsOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface EntryOrBuilder extends
      ...
      /**
       * <code>optional string name_regexp = 7;</code>
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      private volatile java.lang.Object nameRegexp_;
      /**
       * <code>optional string name_regexp = 7;</code>
       */
       ...
       * <code>optional string name_regexp = 7;</code>
       */
      public java.lang.String getNameRegexp() {
        java.lang.Object ref = nameRegexp_;
        if (ref instanceof java.lang.String) {
          return (java.lang.String) ref;
        } else {
          com.google.protobuf.ByteString bs = 
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (((bitField0_ & 0x00000002) == 0x00000002)) {
          com.google.protobuf.GeneratedMessageV3.writeString(output, 7, nameRegexp_);
        }
        unknownFields.writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000002) == 0x00000002)) {
          size += com.google.protobuf.GeneratedMessageV3.computeStringSize(7, nameRegexp_);
        }
        size += unknownFields.getSerializedSize();
        memoizedSize = size;
        return size;
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        result = result && (hasNameRegexp() == other.hasNameRegexp());
        if (hasNameRegexp()) {
          result = result && getNameRegexp()
              .equals(other.getNameRegexp());
        }
      ...
      public int hashCode() {
        ...
        if (hasNameRegexp()) {
          hash = (37 * hash) + NAME_REGEXP_FIELD_NUMBER;
          hash = (53 * hash) + getNameRegexp().hashCode();
        }
        if (hasMin()) {
      ...
      public static final class Builder extends
        ...
        public toco.ModelFlagsOuterClass.ArraysExtraInfo.Entry buildPartial() {
          ...
          result.nameRegexp_ = nameRegexp_;
          if (((from_bitField0_ & 0x00000004) == 0x00000004)) {
            to_bitField0_ |= 0x00000004;
          }
          result.min_ = min_;
  ...
  bitField0_ |= 0x00000001;
        ...
        private java.lang.Object nameRegexp_ = "";
        /**
         * <code>optional string name_regexp = 7;</code>
         */
        public boolean hasNameRegexp() {
  ...
  bitField0_ |= 0x00000002;
        ...
        public Builder clearNameRegexp() {
          bitField0_ = (bitField0_ & ~0x00000002);
          nameRegexp_ = getDefaultInstance().getNameRegexp();
          onChanged();
          return this;
        }
        /**
         * <code>optional string name_regexp = 7;</code>
         */
        public Builder setNameRegexpBytes(
            com.google.protobuf.ByteString value) {
          if (value == null) {
    throw new NullPointerException();
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\021model_flags.proto\022\004toco\032 tensorflow/li" +
      "te/toco/types.proto\"\037\n\017InputArrayShape\022\014" +
      "\n\004dims\030\002 \003(\005\"\217\001\n\nInputArray\022\014\n\004name\030\001 \001(" +
      "\t\022$\n\005shape\030\006 \001(\0132\025.toco.InputArrayShape\022" +
      "\022\n\nmean_value\030\003 \001(\002\022\024\n\tstd_value\030\004 \001(\002:\001" +
      "1\022#\n\tdata_type\030\005 \001(\0162\020.toco.IODataType\"b" +
      "\n\010RnnState\022\023\n\013state_array\030\001 \001(\t\022\036\n\026back_" +
      "edge_source_array\030\002 \001(\t\022\023\n\013discardable\030\005" +
      " \001(\010\022\014\n\004size\030\003 \001(\005\"\357\001\n\017ArraysExtraInfo\022," +
      "\n\007entries\030\001 \003(\0132\033.toco.ArraysExtraInfo.E" +
      "ntry\032\255\001\n\005Entry\022\014\n\004name\030\001 \001(\t\022\023\n\013name_reg" +
      "exp\030\007 \001(\t\022\013\n\003min\030\002 \001(\001\022\013\n\003max\030\003 \001(\001\022#\n\td" +
      "ata_type\030\004 \001(\0162\020.toco.IODataType\022$\n\005shap" +
      "e\030\005 \001(\0132\025.toco.InputArrayShape\022\034\n\024consta" +
      "nt_float_value\030\006 \001(\002\"\255\003\n\nModelFlags\022&\n\014i" +
      "nput_arrays\030\001 \003(\0132\020.toco.InputArray\022\025\n\ro" +
      "utput_arrays\030\002 \003(\t\022\026\n\016variable_batch\030\n \001" +
      "(\010\022\"\n\nrnn_states\030\014 \003(\0132\016.toco.RnnState\0221" +
      "\n\014model_checks\030\016 \003(\0132\033.toco.ModelFlags.M" +
      "odelCheck\022 \n\030allow_nonexistent_arrays\030\020 " +
      "\001(\010\022\035\n\025allow_nonascii_arrays\030\021 \001(\010\0220\n\021ar" +
      "rays_extra_info\030\022 \001(\0132\025.toco.ArraysExtra" +
      "Info\022(\n\032change_concat_input_ranges\030\023 \001(\010" +
      ":\004true\032T\n\nModelCheck\022\030\n\ncount_type\030\001 \001(\t" +
      ":\004None\022\025\n\tcount_min\030\002 \001(\005:\002-1\022\025\n\tcount_m" +
      "ax\030\003 \001(\005:\002-1"
    };
    ...
    internal_static_toco_ArraysExtraInfo_Entry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_toco_ArraysExtraInfo_Entry_descriptor,
        new java.lang.String[] { "Name", "NameRegexp", "Min", "Max", "DataType", "Shape", "ConstantFloatValue", });
    internal_static_toco_ModelFlags_descriptor =
