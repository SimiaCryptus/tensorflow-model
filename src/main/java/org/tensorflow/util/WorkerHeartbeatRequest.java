...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    boolean result = true;
    result = result && shutdownMode_ == other.shutdownMode_;
    result = result && (hasWatchdogConfig() == other.hasWatchdogConfig());
    if (hasWatchdogConfig()) {
      result = result && getWatchdogConfig()
          .equals(other.getWatchdogConfig());
    }
  ...
  public static final class Builder extends
    ...
    private org.tensorflow.util.WatchdogConfig watchdogConfig_ = null;
