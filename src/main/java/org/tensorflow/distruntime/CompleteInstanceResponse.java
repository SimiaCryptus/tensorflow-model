...
private static final long serialVersionUID = 0L;
  ...
  public static final int COMMUNICATOR_KEY_FIELD_NUMBER = 3;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!communicatorKey_.isEmpty()) {
      output.writeBytes(3, communicatorKey_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!communicatorKey_.isEmpty()) {
      size += com.google.protobuf.CodedOutputStream
        .computeBytesSize(3, communicatorKey_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && (getSourceRank()
        == other.getSourceRank());
    result = result && getCommunicatorKey()
        .equals(other.getCommunicatorKey());
